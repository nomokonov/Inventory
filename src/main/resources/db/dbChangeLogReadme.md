При внесении изменений в базу данных во время решения своей задачи, необходимо добавлять в файл  [**dbChangeLog.xml**](changelog/dbChangeLog.xml)  блок _\<changeSet>_.
